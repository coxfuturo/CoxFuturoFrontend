...
const SaaSDevelopment = () => {
  ...
  return (
    <>
      {/* ================= HERO ================= */}
      <section className="relative min-h-screen bg-gradient-to-br from-[#1E293B] via-[#0F172A] to-[#1E293B] flex items-center overflow-hidden">
      ...
      <section className="py-24 bg-[#0F172A]">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            <img src="/images/saas/about.jpg" alt="SaaS Benefits" className="rounded-2xl shadow-2xl w-full" />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-black">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-14 items-center">
          <img src="/images/saas/process.jpg" alt="SaaS Process" className="rounded-2xl shadow-2xl w-full" />
      ...
      {/* ================= CTA ================= */}
      <section className="py-24 bg-gradient-to-br from-[#1E293B] via-[#0F172A] to-[#1E293B] text-center">
