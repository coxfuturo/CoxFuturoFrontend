...
const EcommerceWebsite = () => {
  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="rounded-3xl overflow-hidden shadow-2xl border border-white/10">
                <img
                  src="https://images.unsplash.com/photo-1515165562835-c4c1b572a9d8?auto=format&fit=crop&w=1000"
                  alt="Ecommerce Website"
                  className="w-full h-full object-cover"
                />
              </div>

              <div className="absolute -bottom-6 -left-6 bg-black/70 rounded-xl p-4">
                <p className="text-xs text-gray-400">Avg Conversion Boost</p>
      ...
      {/* ================= TRUST STRIP ================= */}
      <section className="py-10 bg-[#11141B] border-y border-white/10">
