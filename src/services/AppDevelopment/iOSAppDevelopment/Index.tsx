...
const IOSAppDevelopment = () => {
  ...
  return (
    <>
      {/* ================= HERO ================= */}
      <section className="relative min-h-screen bg-gradient-to-br from-black via-[#0F172A] to-black flex items-center overflow-hidden">
      ...
      {/* ================= CTA ================= */}
      <section className="py-24 bg-gradient-to-br from-black to-[#111827] text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 text-white">
