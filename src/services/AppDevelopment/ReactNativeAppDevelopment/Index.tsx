...
const ReactNativeDevelopment = () => {
  ...
  return (
    <>
      {/* ================= HERO ================= */}
      <section className="relative min-h-screen bg-gradient-to-br from-[#0F172A] via-black to-[#0F172A] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-28 mt-16 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.2 }}>
            <img
              src="/images/react-native/hero.jpg"
      ...
      <section className="py-24 bg-black">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            <img src="/images/react-native/about.jpg" alt="React Native Benefits" className="rounded-2xl shadow-2xl w-full" />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-black">
        <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-14 items-center">
          <img src="/images/react-native/process.jpg" alt="React Native Process" className="rounded-2xl shadow-2xl w-full" />
      ...
      {/* ================= CTA ================= */}
      <section className="py-24 bg-gradient-to-br from-[#0F172A] via-black to-[#0F172A] text-center">
